...
namespace mp.pddn
{
    ...
    /// </summary>
    public class SlimDxVector2Converter : TypeConverter
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class SlimDxVector3Converter : TypeConverter
    {
        /// <inheritdoc />
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
    ...
    /// </summary>
    public class SlimDxVector4Converter : TypeConverter
    {
        /// <inheritdoc />
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
    ...
    /// </summary>
    public class SlimDxQuaternionConverter : TypeConverter
    {
        /// <inheritdoc />
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
    ...
    /// <inheritdoc />
    /// <summary>
    /// String converter for <see cref="Color4" />
    /// </summary>
    public class SlimDxColor4Converter : TypeConverter
    {
        /// <inheritdoc />
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string) && value is Color4 v)
            {
                return $"{v.Red.ToString(CultureInfo.InvariantCulture)}, {v.Green.ToString(CultureInfo.InvariantCulture)}, {v.Blue.ToString(CultureInfo.InvariantCulture)}, {v.Alpha.ToString(CultureInfo.InvariantCulture)}";
            }
            return base.ConvertTo(context, culture, value, destinationType);
        }
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                var comps = sval.Split(new[] { ", " }, StringSplitOptions.RemoveEmptyEntries);
                if (comps.Length < 4) return new Color4(0, 0, 0, 1);
                return new Color4(
                    float.Parse(comps[0].Trim(), CultureInfo.InvariantCulture),
                    float.Parse(comps[1].Trim(), CultureInfo.InvariantCulture),
                    float.Parse(comps[2].Trim(), CultureInfo.InvariantCulture),
    ...
    /// <inheritdoc />
    /// <summary>
    /// String converter for <see cref="Matrix" />
    /// </summary>
    public class SlimDxMatrixConverter : TypeConverter
    {
        /// <inheritdoc />
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string) && value is Matrix m)
            {
                var res = "";
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                var comps = sval.Split(new[] { ", " }, StringSplitOptions.RemoveEmptyEntries);
                if (comps.Length < 16) return Matrix.Identity;
                return new Matrix
                {
